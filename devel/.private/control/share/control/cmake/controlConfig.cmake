...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/ainiaalif/project_mobil/src/control)
  set(control_DEVEL_PREFIX /home/ainiaalif/project_mobil/devel/.private/control)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/ainiaalif/project_mobil/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ainiaalif/project_mobil/src/control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ainiaalif/project_mobil/devel/.private/control/lib;/home/ainiaalif/project_mobil/install/lib;/opt/ros/kinetic/lib)
